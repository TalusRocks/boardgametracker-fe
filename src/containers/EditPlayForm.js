...
import { searchBoardGameGeek, editPlay } from '../actions'


class EditPlayForm extends Component {
  constructor(props) {
    super(props)
  ...
  submitEditPlay = (e) => {
    ...
    // const playId
    //
    // this.props.editPlay(newPlayParams, playId)
  ...
  render() {
    return this.state.fireRedirect === true ? <Redirect to="/plays"/> : (
      <div>
        ...
        <div className="m-1">
          <form onSubmit={this.submitEditPlay}>
            <div className="mtb-2">
              <label>
...
const mapDispatchToProps = dispatch => {
  return bindActionCreators({ searchBoardGameGeek, editPlay }, dispatch)
}
